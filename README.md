...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-1.9.9-yellow"></a>
</p>
...
* **Вставка кода (Сниппеты):**
    ...
    * **Заменить табы на пробелы:** При сохранении файла автоматически конвертирует табуляции на 4 пробела.
