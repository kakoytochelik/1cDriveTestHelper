...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-1.10.5-yellow"></a>
</p>
...
#### Сборка тестов:
  ...
  * Нсли задано в настройках, автоматически вычищает "ненужные" шаги из определенных тестов (001_Company, I_start_my_first_launch)
  * Управление сборкой:
...
2.  **Настройка:**<br>
    ...
    * **Настройки сборки**:
      * `Split Feature Files`: Сохранять приложенные к тестам файлы в отдельную папку (по умолчанию выкл.).
    ...
    * **Настройки параметров запуска**:
      ...
      * `BuildScenarioBDD Parameters`: Дополнительные параметры при выполнении обработки СборкаТекстовСценариев (необязательно).
    * **Настройки системных путей**:
      ...
      * `YAML Parameters Template`: Путь к шаблону yaml_parameters.json внутри проекта (по умолчанию `build/develop_parallel/yaml_parameters.json`).
