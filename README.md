...
[![Версия](https://img.shields.io/badge/version-1.7.2-yellow)](./package.json) 
...
### Сборка тестов:
  ...
  * В настройках расширения можно указать параметры тестовой почты и отключить автоматическое открытие панели `Output` при ошибках.
...
2.  **Настройка:**<br>
    ...
    * **Настройки базы сборки**:
      ...
      * `Show Output On Error`: Показывать панель Output при ошибке сборки тестов (по умолчанию выкл.).
