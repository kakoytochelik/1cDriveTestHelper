...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-1.11.0-yellow"></a>
</p>
...
**Универсальное решение:** Хотя изначально расширение было разработано для тестирования конфигурации 1C:Drive, оно совместимо с любыми другими проектами тестирования 1С, которые используют YAML-файлы сценариев и используют Vanessa Automation. Оно работает с проектами, построенными по методологии [СППР](https://its.1c.ru/db/sppr2doc#content:124:hdoc), и может быть использовано для других проектов 1С.
...
#### Менеджер параметров Сборки Сценариев:
  ...
  * **Доступ:** Кнопка в панели Assembly, палитра команд и настройки расширения.
...
* **Методология СППР:** Совместимо с проектами, использующими методологию СППР (СППР) для автоматизации тестирования 1С.
* **Vanessa Automation:** Работает с любыми проектами, следующими структуре YAML-сценариев и применимо к любому проекту 1С.
