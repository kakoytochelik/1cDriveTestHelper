...
# 1.10.7
- **Исправления**:
    - **Исправлена недоступность кнопки обновления:** Кнопка "Обновить" теперь всегда доступна, даже когда не найдено ни одного теста для Phase Switcher. Это позволяет пользователям повторить сканирование в случае отсутствия тестов или смены директории тестов.
    ...
    - Исправлены непереведенные сообщения.
